            ...
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">${tbContentCategory.id == null ? "新增" : "编辑"}分类</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save"
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <label class="col-sm-2 col-control-label">父级类目</label>

                                <div class="col-sm-10">
                                    <form:hidden id="parentId" path="parent.id"/>
                                    <input id="parentName" class="form-control" placeholder="请选择"
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-control-label">分类名称</label>
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-sm-2 col-control-label">分类排序</label>
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-default" onclick="history.go(-1);">返回
                            </button>
